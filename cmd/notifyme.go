...
import (
	...
	"github.com/segflow/notifyme/carriers"
	"github.com/segflow/notifyme/notification"

	isatty "github.com/mattn/go-isatty"
	"github.com/segflow/notifyme/argparser"
	"github.com/segflow/notifyme/command"
	"github.com/segflow/notifyme/config"

	// import carriers so they get registered
	_ "github.com/segflow/notifyme/carriers/file"
	_ "github.com/segflow/notifyme/carriers/slack"
...
func main() {
	...
	if !isatty.IsTerminal(os.Stdout.Fd()) {
		log.Warnln("It seems like the output is piped.")
	}
